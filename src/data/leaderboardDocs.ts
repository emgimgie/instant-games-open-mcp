...
export interface LeaderboardPattern {
  name: string;
  description: string;
  example: string;
}

export interface LeaderboardPractice {
  category: string;
  items: string[];
}
...
export interface LeaderboardDocumentation {
  ...
  integration_patterns: {
    title: string;
    description: string;
    patterns: LeaderboardPattern[];
  };
  best_practices: {
    title: string;
    description: string;
    practices: LeaderboardPractice[];
  };
}
...
export const LEADERBOARD_SEARCH_INDEX: Record<string, string[]> = {
