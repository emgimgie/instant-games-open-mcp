...
export interface CloudSaveFeature {
  name: string;
  description: string;
  example: string;
}

export interface CloudSavePractice {
  category: string;
  items: string[];
}

export interface CloudSaveCategory {
  title: string;
  description: string;
  apis?: CloudSaveAPI[];
  features?: CloudSaveFeature[];
  practices?: CloudSavePractice[];
}

export interface CloudSaveDocumentation {
  title: string;
  description: string;
  categories: Record<string, CloudSaveCategory>;
}
...
export const CLOUD_SAVE_SEARCH_INDEX: Record<string, string[]> = {
